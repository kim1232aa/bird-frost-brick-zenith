...
export const PRESET_RELAY_ENDPOINTS: Array<Partial<ApiRelayProvider>> = [
    ...
    },
    {
        ...
        imageCapabilityProfiles: {
            "grok-imagine-image": { generate: "xai-grok-image-generate", edit: "xai-grok-imagine-edit" },
            "grok-imagine-image-quality": { generate: "xai-grok-image-generate", edit: "xai-grok-imagine-edit" },
        },
    ...
    },
    {
        ...
        remark: "SenseNova 日日新。生图 U1 / U1.5，默认 2048x2048。无视频。",
        models: ["sensenova-6.8-flash-lite", "sensenova-6.7-flash-lite", "deepseek-v4-flash", "glm-5.2", "sensenova-u1-fast", "sensenova-u1.5-lite"],
    ...
    },
    {
        ...
        enabled: false,
        capabilities: ["text", "image", "video"],
        remark: "官方 apihub。生图 2.1 Flash，视频 2.5 Flash（720P，首尾帧/参考图）。",
        models: [
            "agnes-2.5-pro",
            "agnes-2.5-flash",
        ...
        textModels: ["agnes-2.5-pro", "agnes-2.5-flash", "agnes-2.5-pro-alpha"],
