...
export const PRESET_RELAY_ENDPOINTS: Array<Partial<ApiRelayProvider>> = [
    ...
    },
    {
        ...
        enabled: true,
        capabilities: ["text", "image", "video"],
        remark: "火山方舟 Agentplan / Seedream 生图 / Seedance 生视频",
        models: [
            ARK_TEXT_EP,
            ARK_IMAGE_EP,
    ...
    },
    {
        ...
        name: "Grok 中转",
        baseUrl: "https://sub.alibb123.ccwu.cc/v1",
        apiKey: "sk-aceb8c49ec16c4c8a0c0f5e46e38f2b638a61e4734ea65586169ee0a77cd8c12",
    ...
    },
    {
        ...
        apiKey: "a437ae76-0d52-40a5-8939-ac0871d69859:438a74c54888f32a78c44afbedeea0b7",
        adapterType: "fal",
        authScheme: "Key",
        enabled: true,
        capabilities: ["image"],
    ...
    },
    {
        ...
        apiKey: "ms-b6d0d9f7-a14e-427f-83a8-664e46a2266c",
        adapterType: "modelscope",
        enabled: true,
        capabilities: ["image"],
    ...
    },
    {
        ...
        apiKey: "sk-nano-aff677d0-b08b-4743-ae16-d1fb4ca4a6d1",
