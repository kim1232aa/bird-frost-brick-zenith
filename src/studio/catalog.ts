...
const META: Record<string, Partial<ModelCard>> = {
  ...
  "grok-imagine-image": { tags: ["Imagine", "宽松", "编辑最多3张参考"], nsfw: true, cost: "中转", blurb: "Imagine 生图，尺度比 GPT Image 松。官方编辑最多 3 张参考图。", verified: true },
  "grok-imagine-image-quality": { tags: ["Imagine", "高质", "编辑最多3张参考"], nsfw: true, cost: "中转", blurb: "Imagine 高质量档。官方编辑最多 3 张参考图。" },
