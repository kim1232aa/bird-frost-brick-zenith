...
const META: Record<string, Partial<ModelCard>> = {
  ...
  "agnes-image-2.1-flash": { tags: ["美国", "推荐"], cost: "Agnes", size: "1K–4K", blurb: "Agnes 生图主力。可带参考图。", region: "us" },
  "agnes-image-2.0-flash": { tags: ["美国"], cost: "Agnes", size: "1024", blurb: "Agnes 上一档生图。", region: "us" },
  "agnes-video-2.5-flash": { tags: ["美国", "推荐"], cost: "Agnes", size: "720P", blurb: "Agnes 视频加速档。文生、开头/结尾图、最多 5 张参考。", region: "us" },
  "agnes-video-2.5": { tags: ["美国"], cost: "Agnes", size: "720P–2K", blurb: "Agnes 视频完整档，清晰度比 Flash 高。", region: "us" },
  ...
  "agnes-2.5-pro-beta": { tags: ["美国"], cost: "Agnes", blurb: "Agnes 文本 Pro Beta。", region: "us" },
  "agnes-2.5-pro-alpha": { tags: ["美国"], cost: "Agnes", blurb: "Agnes 文本 Pro Alpha。", region: "us" },
  "agnes-2.5-flash": { tags: ["美国"], cost: "Agnes", blurb: "Agnes 文本加速档。", region: "us" },
  "agnes-2.0-flash": { tags: ["美国"], cost: "Agnes", blurb: "Agnes 文本 2.0。", region: "us" },
  ...
  "sensenova-6.7-flash-lite": { tags: ["中国"], cost: "日日新", blurb: "商汤 6.7 文本。", region: "cn" },
  "sensenova-6.8-flash-lite": { tags: ["中国"], cost: "日日新", blurb: "商汤 6.8 文本。", region: "cn" },
  "deepseek-v4-flash": { tags: ["中国"], cost: "日日新", blurb: "商汤渠道上的 DeepSeek V4。", region: "cn" },
  "glm-5.2": { tags: ["中国"], cost: "日日新", blurb: "商汤渠道上的智谱 GLM-5.2。", region: "cn" },
