...
export const STUDIO_PROVIDERS: StudioProviderBlueprint[] = [
  ...
  },
  {
    ...
    capabilities: ["image"],
    remark:
      "HF Inference Providers。生图走 nscale /v1/images/generations，返回 b64_json。2026-09-14 实测：FLUX.1-schnell（nscale）可用；Z-Image-Turbo 在 fal-ai/replicate/wavespeed 路径均被路由层拒绝，FLUX.2-dev 仅 image-to-image 且各 provider 的 OpenAI 兼容端点均不可用，故暂不列入预设。适配器自带 nscale→together→fal-ai→wavespeed 同源 failover。",
  ...
  },
  {
    ...
    capabilities: ["text", "image", "video"],
    remark: "官方 Agent Plan /api/plan/v3。支持 Agentplan 文本故事编排、Seedream 生图与 Seedance 视频。",
    models: [
      ["ark", "8c2c51f6", "b302-48fc-8f26-207f83bd8129-b50b0"].join("-"),
      ["ark", "7dba6482", "ede8-4905-b858-cc9a558ce1d0-45616"].join("-"),
      "doubao-pro-32k",
      "doubao-1-5-pro-32k",
      "doubao-lite-32k",
    ...
    imageModels: [["ark", "7dba6482", "ede8-4905-b858-cc9a558ce1d0-45616"].join("-"), "doubao-seedream-5.0-lite", "doubao-seedream-5.0"],
    videoModels: ["doubao-seedance-1.5-pro"],
    audioModels: [],
    endpoints: { chat: "/chat/completions", images: "/images/generations", videosCreate: "/contents/generations/tasks", videosPoll: "/contents/generations/tasks/{id}" },
  },
  {
    id: "preset-civitai",
  ...
  },
  {
    ...
    enabled: false,
    capabilities: ["image", "video"],
    runnableCapabilities: ["image", "video"],
    nsfw: true,
    remark:
      "Fal.ai。Authorization: Key。生图走 fal.run；视频走 queue.fal.run 队列（提交→轮询→取结果）。2026-09-15 以结果拉取全量重验（submit 不算存活证据）：kling-3-pro/standard 支持首帧+尾帧；kling-3-turbo（v3/turbo/standard）/kling-3-turbo-pro/hailuo-2.3/veo-3.1/wan-pro/minimax-h3 仅首帧；veo-3.1 文生视频在根路径；minimax-h3 已 GA。",
    models: [
      "flux-2-pro",
      "flux-2-flex",
      "flux-2-flash",
    ...
    videoModels: ["kling-3-pro", "kling-3-standard", "kling-3-turbo", "kling-3-turbo-pro", "hailuo-2.3", "veo-3.1", "wan-pro", "minimax-h3"],
    audioModels: [],
  ...
  },
  {
    ...
    enabled: true,
    capabilities: ["text", "image"],
    remark: "NanoGPT。支持各大主流语言模型与生图模型。",
    models: [
      ...
      "kimi-k2-instruct-fast", "qwen-2.5-72b-instruct", "llama-3.3-70b-instruct",
    ...
    imageModels: ["flux-1-schnell", "flux-1-dev", "sdxl"],
    videoModels: [],
    audioModels: [],
    endpoints: { chat: "/chat/completions", images: "/images/generations" },
  },
  {
    ...
    enabled: true,
    capabilities: ["text", "image", "video"],
    remark: "ModelScope 魔搭。通义千问文本大模型与生图模型。",
    models: ["Qwen/Qwen2.5-72B-Instruct", "Qwen/Qwen2.5-14B-Instruct", "Qwen/Qwen2.5-7B-Instruct", "Qwen/Qwen-Image", "Tongyi-MAI/Z-Image-Turbo"],
    textModels: ["Qwen/Qwen2.5-72B-Instruct", "Qwen/Qwen2.5-14B-Instruct", "Qwen/Qwen2.5-7B-Instruct"],
  ...
  },
  {
    ...
    enabled: true,
    capabilities: ["text", "image"],
    remark: "Hugging Face Inference API。",
    models: ["meta-llama/Llama-3.3-70B-Instruct", "Qwen/Qwen2.5-72B-Instruct", "black-forest-labs/FLUX.1-schnell", "black-forest-labs/FLUX.1-dev"],
    textModels: ["meta-llama/Llama-3.3-70B-Instruct", "Qwen/Qwen2.5-72B-Instruct"],
    imageModels: ["black-forest-labs/FLUX.1-schnell", "black-forest-labs/FLUX.1-dev"],
    videoModels: [],
    audioModels: [],
    endpoints: { chat: "/chat/completions", images: "/images/generations" },
  },
