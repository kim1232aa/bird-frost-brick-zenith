...
export const STUDIO_PROVIDERS: StudioProviderBlueprint[] = [
  {
    ...
    remark: "Grok Imagine 图 / 视频 / 文本（未配置中转端点与凭据，请在设置中填写）。图生图走 /images/edits，最多 3 张参考；视频走首帧+尾帧+分镜静帧。",
    models: [
      "grok-4.6",
      "grok-4.5",
      "grok-4.3",
  ...
  },
  {
    ...
    remark: "可灵官方 API 未接线模板。如需直接可用，请使用 Fal 渠道中的可灵模型。",
    models: ["kling-v3", "kling-v3-omni"],
    textModels: [],
    imageModels: [],
    videoModels: ["kling-v3", "kling-v3-omni"],
    audioModels: [],
    endpoints: { videosCreate: "/videos" },
  },
  {
    id: "preset-minimax",
    name: "MiniMax · 海螺 (未接线)",
